...
const Team = () => {
    ...
    return (
        <div className="  fontRoboto flex flex-col items-center justify-between pt-20 h-auto ">
            ...
            <div className="overflow-hidden">  <p className='text-black md:px-20  md:mt-[20px] fontRoboto text-xs md:text-lg md:text-center text-justify '>Pinnacle is led by a team of specialists who are passionate about fashion vertical, with one goal: helping the apparel retail world to discover, develop and deliver products at digital speed. It connects different stakeholders on a single digital platform and allows fashion companies to be agile and quick.</p></div>
            ...
            <div className="flex gap-5">  <>
                ...
                <div className="wrapper">
                    ...
                    <div className="profile">
                        ...
                        <h1 className="name">Manoj P, CEO</h1>
                ...
                <>
                    ...
                    <div className="wrapper">
                        ...
                        <div className="profile">
                            ...
                            <h3 className=" text-2xl font-semibold name">Anbu, Head Sales</h3>
                    ...
                    <div className="wrapper">
                        ...
                        <div className="profile">
                            ...
                            <h3 className="name">Satheesh Kumar, Project Head</h3>
                            <p className='description'>
            ...
            <div className="relative">  <Image
                alt="Developer"
                src={team}
                className=" md:rounded-3xl rounded-lg pt-5 h-[75vh] w-[85vw] border-t-2 border-b-2  object-cover opacity-50 transition-opacity hover:opacity-100"
            />
                <h1 className='absolute top-[4%] left-[45%] text-[3rem] text-black pt-4 text-center  text-2xl text-black  font-semibold '>Our Crew</h1></div>


            <div className="overflow-hidden">  <p className='text-black md:px-20  md:mt-[20px] fontRoboto text-xs md:text-lg md:text-center text-justify '>
