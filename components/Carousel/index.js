...
const Slider = () => {
  ...
  return (
    <div className='flex flex-col items-center w-screen'>
      ...
      {
        <div className='flex flex-col md:w-[100vw] w-[100vw] mx-auto bg-white rounded-xl shadow-md overflow-hidden  items-center justify-center'>
          ...
          <div className='text-black flex text-xs md:text-lg text-center md:text-left md:pl-8 pl1'>
            ...
            <div className='ml-2 grid md:grid-cols-2 '>
              <div className='text-black  text-xs  md:text-lg text-center md:text-left'>
                <div className='container md:w-3/4 w-[80vw] items-stretch mx-4 rounded-md  shadow-lg'>
                  <h1 className=' text-center md:text-xl text-lg leading-tight font-bold text-transparent bg-clip-text bg-gradient-to-br from-blue-700 via-blue-500 to-blue-900 '>Top ERP System Tailored for You</h1>
                  <p className="mb-2 p-2   font-normal text-[1rem] font-extralight p-8 ">Considered as one of the top ERP systems globally, is built on the latest ERP technology.
              ...
              <div className='text-black   text-xs  md:text-lg text-center md:text-left '>
                <div className='container md:w-3/4 w-[80vw] items-stretch mx-4 rounded-md  shadow-lg'>
                  <h1 className=' text-center md:text-xl text-lg leading-tight font-bold text-transparent bg-clip-text bg-gradient-to-br from-red-600 to-yellow-500'>Robust Security and Compliance</h1>
                  <p className="mb-2 p-2   font-normal  text-justify text-[1rem] font-extralight  p-8">Our cloud-based ERP for small business and large enterprises is designed with top-tier security measures to safeguard your business's critical data.
              ...
              <div className='text-black  md:mt-8 text-xs  md:text-lg text-center md:text-left'>
                <div className='container md:w-3/4 w-[80vw] items-stretch mx-4 rounded-md  shadow-lg'>
                  <h1 className=' text-center md:text-xl text-lg leading-tight font-bold text-transparent bg-clip-text bg-gradient-to-br from-blue-700 via-blue-500 to-blue-900 '>Redefining ERP with  Latest Version</h1>
                  <p className="mb-2 p-2  font-normal   text-justify text-[1rem] font-extralight  p-8 ">Get ahead of your competition with our new ERP system, which offers a host of benefits of cloud ERP.
              ...
              <div className='text-black md:mt-8 text-xs  md:text-lg text-center md:text-left'>
                <div className='container md:w-3/4 w-[80vw] items-stretch mx-4 rounded-md  shadow-lg'>
                  <h1 className='text-center md:text-xl text-lg leading-tight font-bold text-transparent bg-clip-text bg-gradient-to-br from-blue-700 via-blue-500 to-blue-900 '>Ease of Use and Accessibility</h1>
                  <p className="mb-2 p-2  font-normal   text-justify text-[1rem] font-extralight  p-8">
